...
//-----------------NESNELERİMİZ---------------------------------
    ...
    //-----------------UYE SORGULAMADA TUTULACAK YARDIMCI NESNELER--------------
   ...
   private String dbuyekullaniciadi;
    ...
    //------------------VERITABANI ISLEMLERI ICIN KULLANILACAK NESNELER---------
    Connection con = null;
    ResultSet resultSet = null;
    PreparedStatement preparedStatement = null;
    //--------------VERI SORGULAMA METODU---------------------------------------
    public void veriSorgula(String gelenKullaniciAdi, String gelenParola){
        try{
            ...
            uyekullaniciadi = resultSet.getString("uyekullaniciadi");
            uyeparola = resultSet.getString("uyeparola");
            uyeeposta = resultSet.getString("uyeeposta");
        }
        catch(Exception e){
    ...
    public String uyeGirisiniDenetle(){
        ...
        if(uyekullaniciadi.equalsIgnoreCase(dbuyekullaniciadi) && uyeparola.equalsIgnoreCase(dbuyeparola)){
            return "uyegirisibasarili";
        }
        else{
            return "uyegirisibasarisiz";
        }
    }
    ...
    public String uyeCikisiniDenetle(){
        ...
        System.out.println("Tebrikler çıkış işlemi başarıyla gerçekleşti");
        return "uyecikisi?faces-redirect=true";
    }
    //----------------YENI KULLANICI OLUSTURMAK ICIN KULLANILAN NESNELER--------
    ...
    public String uyeKayidiniDenetle(){
        ...
        if(yeniuyekullaniciadi.equalsIgnoreCase(dbuyekullaniciadi) && yeniuyeparola.equalsIgnoreCase(dbuyeparola)){
            return "uyeeklemebasarili";
        }else{
            return "uyeeklemebasarisiz";
        }
    }
    
    //---------------------YENI UYE EKLEME METODU-------------------------------
    ...
    //--------------UYE DUZENLEME METODU----------------------------------------
    private void veriDuzenle(String uyekullaniciadi, String uyeparola, String uyeeposta, int uyeid){
        
        String durumbilgisi ="";
        try{
            Class.forName("com.mysql.jdbc.Driver");
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/firmaveritabani", "root", "");
            String duzenlemeSorgusu = "UPDATE uye SET uyekullaniciadi = ?, uyeparola = ?, uyeeposta = ? WHERE uyeid = ?";
            ...
            if(eklemeDurumu == 1){
                ...
                durumbilgisi = "kayıt guncellenemedi";
            }
        }
        catch(Exception e){
            System.out.println("hata :" + e);
    ...
    public String  uyeDuzenlemeyiDenetle(){
        ...
        if(uyekullaniciadi.equalsIgnoreCase(dbuyekullaniciadi) && uyeparola.equalsIgnoreCase(dbuyeparola)){
            return "uyeduzenlemebasarili";
        }else{
            return "uyeduzenlemebasarisiz";
        }
    }
    ...
    private void veriSil(int uyeid){
        ...
        try{
            ...
            if(silmeDurumu == false){
                durumbilgisi ="tebrikler silme işlemi başarıyla gerçekleşti";
            }else{
                durumbilgisi ="başarışız bir işlem silme";
           }
          }
        catch(SQLException e){
            System.out.println("hata " + e);
